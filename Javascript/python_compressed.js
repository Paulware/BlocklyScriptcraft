...
Blockly.Python.init=function(a){
   ...
   for(var c=0;c<a.length;c++){
      myName = Blockly.Python.variableDB_.getName(a[c],Blockly.Variables.NAME_TYPE);
      if (myName.indexOf ('int') > -1) { 
         b[c]="int " + myName +" = 0;";
      } else if (myName.indexOf ( 'bool' ) > -1) {
         b[c]="bool " + myName +" = false;";
      } else { 
         b[c]="byte " + myName +" = 0;";
      }
   }
...
Blockly.Python.lists_length=function(a){return[(Blockly.Python.valueToCode(a,"VALUE",Blockly.Python.ORDER_NONE)||"[]")+".length",Blockly.Python.ORDER_FUNCTION_CALL]};
Blockly.Python.lists_isEmpty=function(a){return["("+(Blockly.Python.valueToCode(a,"VALUE",Blockly.Python.ORDER_NONE)||"[]")+".length == 0)",Blockly.Python.ORDER_LOGICAL_NOT]};
...
Blockly.Python.lists_split=function(a){
   ...
   if("SPLIT"==b)
          ...
          b=Blockly.Python.valueToCode(a,"INPUT",Blockly.Python.ORDER_NONE)||"[]",a=Blockly.Python.valueToCode(a,"DELIM",Blockly.Python.ORDER_MEMBER)||"''",a=b+".join("+a+")";   
   else throw"Unknown mode: "+b;
   return[a,Blockly.Python.ORDER_FUNCTION_CALL]
};
Blockly.Python.math={};Blockly.Python.addReservedWords("math,random,Number");Blockly.Python.math_number=function(a){a=parseFloat(a.getFieldValue("NUM"));var b;Infinity==a?(a='float("inf")',b=Blockly.Python.ORDER_FUNCTION_CALL):-Infinity==a?(a='-float("inf")',b=Blockly.Python.ORDER_UNARY_SIGN):b=0>a?Blockly.Python.ORDER_UNARY_SIGN:Blockly.Python.ORDER_ATOMIC;return[a,b]};
...
Blockly.Python.procedures_defreturn=function(a){
 ...
 Blockly.Python.INFINITE_LOOP_TRAP&&(e=Blockly.Python.INFINITE_LOOP_TRAP.replace(/%1/g,'"'+a.id+'"')+e);
  ...
  b="byte function "+d+"("+g.join(", ")+") {\n"+b+e+f + "\n} // end function\n";
  b=Blockly.Python.scrub_(a,b);Blockly.Python.definitions_["%"+d]=b;return null
};
...
Blockly.Python.text_indexOf=function(a){var b="FIRST"==a.getFieldValue("END")?"indexOf":"lastIndexOf",c=Blockly.Python.valueToCode(a,"FIND",Blockly.Python.ORDER_NONE)||"''",b=(Blockly.Python.valueToCode(a,"VALUE",Blockly.Python.ORDER_MEMBER)||"''")+"."+b+"("+c+")";return a.workspace.options.oneBasedIndex?[b+" + 1",Blockly.Python.ORDER_ADDITIVE]:[b,Blockly.Python.ORDER_FUNCTION_CALL]};
...
Blockly.Python.text_getSubstring=function(a){
 ...
 switch(b){
  ...
  case "FIRST":
    b="";
    break;
  default:throw"Unhandled option (text_getSubstring)";
 }
 switch(c){
  case "FROM_START":
 ...
 if (a != "") {
   return[d+".substring ("+b+","+a+")",Blockly.Python.ORDER_MEMBER]  
 } else {
   return[d+".substring ("+b+")",Blockly.Python.ORDER_MEMBER]  
 }
};
...
Blockly.Python.text_prompt=Blockly.Python.text_prompt_ext;Blockly.Python.loops={};
Blockly.Python.controls_repeat_ext=function(a){
  var b=a.getField("TIMES")?String(parseInt(a.getFieldValue("TIMES"),10)):Blockly.Python.valueToCode(a,"TIMES",Blockly.Python.ORDER_NONE)||"0",b=Blockly.isNumber(b)?parseInt(b,10):"parseInt("+b+")",c=Blockly.Python.statementToCode(a,"DO"),c=Blockly.Python.addLoopTrap(c,a.id)||Blockly.Python.PASS;
  //alert ( 'b: ' + b );
  //alert ( 'a: ' + a );
  var name = a.getFieldValue("VAR"); // Blockly.Python.valueToCode(a,"VAR",Blockly.Python.ORDER_NONE)
  name = name.substring (1,name.length-1);
  var code = Blockly.Python.statementToCode(a,"DO")
  //alert ( 'c: ' + code );
  //var count = b; // Blockly.Python.variableDB_.getDistinctName("count",Blockly.Variables.NAME_TYPE);
  //alert ( 'count: ' + count );
  return "for (var " + name + "=0; " + name + "<"+b+"; " + name + "++) {\n"+c + "}\n"
};
Blockly.Python.controls_repeat=Blockly.Python.controls_repeat_ext;Blockly.Python.controls_whileUntil=function(a){
   // alert ( 'controls_repeat yo' );
   var b="UNTIL"==a.getFieldValue("MODE"),c=Blockly.Python.valueToCode(a,"BOOL",b?Blockly.Python.ORDER_LOGICAL_NOT:Blockly.Python.ORDER_NONE)||"false",d=Blockly.Python.statementToCode(a,"DO"),d=Blockly.Python.addLoopTrap(d,a.id)||Blockly.Python.PASS;
   b&&(c="not "+c);
   return"while ("+c+") {\n"+d + "}\n"
};
